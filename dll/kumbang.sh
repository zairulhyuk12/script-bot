...
clear
bugdigi=/root/.kenzo/.kumbang/digi
bugumo=/root/.kenzo/.kumbang/umobile
bugmaxis=/root/.kenzo/.kumbang/maxis
bugunifi=/root/.kenzo/.kumbang/unifi
bugyodoo=/root/.kenzo/.kumbang/yodoo
bugcelcom=/root/.kenzo/.kumbang/celcom
installed=/root/.kenzo/.kumbang/install
...
mkdir /root/.kenzo
mkdir /root/.kenzo/.kumbang
echo 'kenzo.me' >$bugdigi
echo 'kenzo.me' >$bugumo
echo 'kenzo.me' >$bugmaxis
echo 'kenzo.me' >$bugunifi
echo 'kenzo.me' >$bugyodoo
echo 'kenzo.me' >$bugcelcom
echo 'done' >$installed
clear
kumbang
fi
