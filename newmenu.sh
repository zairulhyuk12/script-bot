...
Exp=$(curl -sS https://raw.githubusercontent.com/kenzotelco/ip-bot/main/ip-bot | grep $MYIP | awk '{print $3}')
fi
chck_b(){
...
curl -sS https://raw.githubusercontent.com/syfqsamvpn/scriptvps/main/clgshow
echo -e "
"
fi
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
